	...
	public List<TransectionDto> Customer_Report(int cus_id) {
		...
		public List calculateDaysLate(int cu_id) {
			...
			String sql="SELECT"
						...
						+" THEN "
						+" (tr_pay_amount * 0.1 * ((CURRENT_DATE - (to_date(pay_date,'YYYYMMDD24H'))) - 3)) ELSE tr_pay_amount "
						...
						+" (tr_pay_amount * 0.1 * ((CURRENT_DATE - (to_date(pay_date,'YYYYMMDD24H'))) - 1)) ELSE tr_pay_amount "
