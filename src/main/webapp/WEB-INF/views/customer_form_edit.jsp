							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="form_cu">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control required"
												name="cu_name" id="cu_name" placeholder="Enter Name"
												value="${cu.cuName}" maxlength="50" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="cu_nick_name"
												class="form-control required" id="cu_nick_name"
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="cu_national_id">ID
											Card</label>
										<div class="col-sm-10">
											<input type="text" name="cu_national_id"
												class="form-control check_number required"
												id="cu_national_id" placeholder="Enter National Card"
												value="${cu.cuNationalID}" maxlength="10">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="cu_phone"
												class="form-control check_number required" id="cu_phone"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="cu_address"
												class="form-control required" id="cu_address"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" name="cu_pawn" rows="5"
												id="cu_pawn" maxlength="100">${cu.cuPawn}</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" name="cu_note" rows="5"
												id="cu_note" maxlength="255">${cu.cuNote}</textarea>
										</div>
									</div>
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="form_gu">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" maxlength="50"
												class="form-control required" name="gu_name" id="gu_name"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" maxlength="50"
												class="form-control  required" name="gu_nick_name"
												id="gu_nick_name" placeholder="Enter Nickname">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" maxlength="50"
												class="form-control required" name="gu_dob" id="gu_dob"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" maxlength="10"
												class="form-control check_number required" name="gu_phone"
												id="gu_phone" placeholder="Enter Phone">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" maxlength="255"
												class="form-control required" name="gu_address"
												id="gu_address" placeholder="Enter Address">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" maxlength="255" rows="5"
												name="gu_pawn" id="gu_pawn"></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" maxlength="255" rows="5"
												name="gu_note" id="gu_note"></textarea>
										</div>
									</div>
								</form>
								<!-- End Form -->
		...
		$(function() {
			...
			function updateCustomer() {
				...
				var input = {
					...
					cuSex : $("#cu_sex").val(),
					cuDOB :moment( $("#datepicker").val(), "DD-MM-YYYY").format(
					"YYYYMMDD"),
			...
			function disableForm(formName) {
				$(formName).find('input, textarea, button, select').attr(
						'disabled', 'disabled');
				valid = true;
				return valid;
			}
