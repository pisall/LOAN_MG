							...
							<div class="panel-body">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="email" class="form-control" id="cu_name"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="email" class="form-control" id="cu_nick_name"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="email" class="form-control" id="cu_dob"
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="cu_id_card">ID
											Card</label>
										<div class="col-sm-10">
											<input type="email" class="form-control" id="cu_id_card"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="email" class="form-control" id="cu_phone"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="email" class="form-control" id="cu_address"
